...
const headCells = [
    ...
    { id: 'fat', numeric: true, disablePadding: false, label: 'Status Code' },
...
export default function MailerListTable(props) {
    ...
    useEffect(() => {
        rows = []
        props.list.map((temp) =>
            rows.push(createData(temp.email, temp.phone, temp.status, temp.status_explain, 0))
        )
    })
